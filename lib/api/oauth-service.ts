...
export class OauthService {
	...
	async metadata(s: AbortSignal): Promise<result.Result<[OauthMetadataResponse, Response], Error>> {
	 ...
	 */
	async introspect(s: AbortSignal, o: OauthIntrospectOptions): Promise<result.Result<[OauthIntrospectResponse, Response], Error>> {
